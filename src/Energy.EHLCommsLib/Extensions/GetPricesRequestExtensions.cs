...
namespace Energy.EHLCommsLib.Extensions
{
    public static class GetPricesRequestExtensions
    {
        ...
        private static void PopulateDetailedUsageForElectricity(GetPricesRequest request, ApiResponse usageTemplate)
        {
        ...
        private static void UpdateItemData(ApiResponse currentSupplyTemplate, string groupName, string itemName, string value)
        {
